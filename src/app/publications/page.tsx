...
import { FaExternalLinkAlt, FaFilePdf, FaCode, FaDesktop, FaQuoteRight } from 'react-icons/fa';
  ...
  return (
    <div className="container mx-auto py-8 sm:py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl sm:text-4xl font-bold mb-6 sm:mb-8">Publications</h1>
